<div class="d-flex justify-content-between align-items-center"  style="height: 40px">
    <div>
        <a class="posts_user-link" href="{{ route('raiting.posts', $user) }}">
        <div class="posts_user-text">
    ...
    <div class="d-flex justify-content-between align-items-center"  style="height: 40px">
        ...
        <p class="text"><span style="color: #0ed529">{{ ($userCommentsCount) ? count($userCommentsCount) : 0  }}</span></p>
    </div>
<div class="d-flex justify-content-between align-items-center"  style="height: 40px">
    <p class="text">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left-text" viewBox="0 0 16 16">
    ...
    <p class="text"><span style="color: #0ed529">ddd</span></p>
</div>
    <div class="d-flex justify-content-between align-items-center" style="height: 40px">
        ...
        <p class="text"><span style="color: #0ed529">{{ count($user->topics) }}</span></p>
    </div>
